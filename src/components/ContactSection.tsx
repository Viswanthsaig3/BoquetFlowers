...
const ContactSection = () => {
  ...
  return (
    <section id="contact" ref={sectionRef} className="py-20 md:py-32 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-40 h-40 bg-primary-100 rounded-full opacity-60 -translate-x-1/2 -translate-y-1/2"></div>
      <div className="absolute bottom-0 right-0 w-60 h-60 bg-secondary-100 rounded-full opacity-70 translate-x-1/3 translate-y-1/3"></div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          >
            Have questions about our flowers or need a custom arrangement? We'd love to hear from you.
          </motion.p>
        </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 mt-1">123 Bloom Street, Floral District, FL 12345</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 mt-1">hello@bloomeuphoria.com</p>
                </div>
              </div>
          ...
          >
            <form className="space-y-6">
              ...
              <div>
                <button 
                  type="submit"
                  className="w-full px-6 py-4 bg-gradient-to-r from-primary-600 to-secondary-700 text-white 
                          font-medium rounded-lg shadow-lg hover:shadow-xl transition-all 
